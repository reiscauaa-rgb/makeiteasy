      ...
      <div className="container">
        <div className={styles.grid}>
          ...
          <div className={styles.brand}>
            ...
            <nav className={styles.socials} aria-label="Redes sociais">
              <a
                href="https://instagram.com/makeiteasy.usa"
                target="_blank"
                rel="noopener noreferrer"
                className={styles.socialLink}
                aria-label="Instagram @makeiteasy.usa"
              >
              ...
              <a
                href="https://linkedin.com/company/makeiteasy-usa"
                target="_blank"
                rel="noopener noreferrer"
                className={styles.socialLink}
                aria-label="LinkedIn @makeiteasy.usa"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {year} Make It Easy USA. Todos os direitos reservados.
          </p>
